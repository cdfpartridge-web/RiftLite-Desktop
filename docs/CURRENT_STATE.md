...
**Published desktop v0.9.77 — 24 September 2026:** Windows, Mac Intel and Mac Apple Silicon are live and Latest from source `d99ba7b`. Includes the Web Replay recovery filter, existing-queue review and Keep local error receipts. Opening Turns Lab now shows Coming soon in desktop Training; its interactive code and hosted support are preserved. [Release and verification receipt](./RELEASE-2026-09-24.md). Both platform gates, 2,352 desktop tests, package/startup checks and all eight public assets passed. Earlier installers, releases and unrelated local work are preserved. Supersedes the desktop availability notes below.

**Latest public desktop release — v0.9.76, 21 September 2026:** Windows, Mac Intel and Mac Apple Silicon are live and Latest. Includes exact-deck Mulligan practice, Atlas Game log, date filters, the training catalog fix and fresh-game capture boundaries. [Release, checks, downloads and artifact receipt](./RELEASE-2026-09-21.md). Source `3f9bde3`; 2,316 desktop tests, both platform release gates, packaged startup and all eight public asset checks passed. All earlier installers and v0.9.75 releases are preserved. Supersedes the local candidates documented below.

**Published desktop release — v0.9.75, 2026-09-18:** Windows, Mac Intel and Mac Apple Silicon are live and Latest from immutable source `64100dba3c8cdd5282595d24d92cabf9f85b80ea`. [Release and verification receipt](./RELEASE-2026-09-18.md). Includes fullscreen toolbar/navigation removal, preserved game/zoom and native Atlas card sampling. **215 files / 2,218 desktop tests**, **82 sync checks**, Windows packaged startup, native Mac signatures/architectures/DMGs/startup and all **8 public asset/updater checks** passed; downloaded Mac packages match the verified compiled output. Canonical installer: **159,373,213 bytes**, SHA256 `D8E6F9200042A57408B01D58FA13226464294E98D44F06CC2447FF87E3F66B94`. Previous canonical v0.9.74 files are preserved in `output/release-v0.9.75-final/previous-canonical-0.9.74/`. Mac remains ad-hoc signed, not notarized; live gameplay visual acceptance remains pending. Android/Your Move and previous local candidates are preserved.

**Published desktop release — v0.9.74, 2026-09-14:** Windows and macOS Intel/Apple Silicon are live and Latest from immutable source `a40a580539f200a00563450d46660642c9c9ae83`. [Release and verification receipt](./RELEASE-2026-09-14.md). Includes the Prepare/Review refresh, Atlas automatic opponent decks and popup/chat fixes, bulk Keep local, movable Mark decision, BO3/data/plan/battlefield improvements and Electron 39.8.10. **214 files / 2,198 desktop tests**, **82 sync checks**, native Mac signatures/packaging/startup, Windows packaged startup, all **8 public asset/updater checks** and **298 matching compiled files per platform** passed. Canonical `release/RiftLiteBetaInstall.exe` is **159,374,976 bytes**, SHA-256 `3CC27FEC249438B4504675C3EE61E406592229AC81E3F381DB3B03CACE8EE56E`; prior files are backed up in `output/release-v0.9.74-runtime-final/previous-canonical-0.9.73/`. Canonical dependencies match the patched runtime. Mac remains ad-hoc signed, not notarized. Signed-in gameplay/chat/deck-import acceptance remains pending. Android and Your Move remain separate; older notices below describe their dated checkpoints.
...
- Release commit `e672f2e70fd16535f0252ac08a447b92c1fecb06` is tagged as Windows `v0.9.37` and macOS `mac-v0.9.37`; both release repositories' `main` and `agent/release-v0.9.12` branches contain that exact release source plus any later publication-documentation commit.
- Windows release: `https://github.com/cdfpartridge-web/RiftLite-Desktop/releases/tag/v0.9.37` and is the repository's current latest release.
- macOS release: `https://github.com/cdfpartridge-web/RiftLite-Desktop-mac/releases/tag/mac-v0.9.37` and is the repository's current latest release. Native workflow `https://github.com/cdfpartridge-web/RiftLite-Desktop-mac/actions/runs/31190117490` completed successfully.
...
- macOS Apple Silicon DMG: 172,797,950 bytes, SHA-256 `AB2A74F148FB747C37CFC074D8E91D050F4D0D89C65C6B19755D0B8813EB1E97`; ZIP: 165,422,204 bytes, SHA-256 `996A5317BC50AAC193470CA8D1D991D25AFC5616402CA888B7601870644ADEC6`.
- macOS Intel DMG: 187,989,640 bytes, SHA-256 `06BF9CA0CCD8CC2E5AD02E861748FD2D8C5DCE7962200CD27E1F2CEFD6F8B639`; ZIP: 180,322,528 bytes, SHA-256 `172C575C347A72857793B354F5949AE6A27F4D04E97EBBB09A8F68AB827063D2`; updater manifest: 830 bytes, SHA-256 `C593425AB79D4F598E3CB62B9E9EC8D9192F38586F046AF3B83A47D95A2FE133`.
- All three Windows and all five macOS assets were independently downloaded after publication and matched their public sizes and SHA-256 digests. Both updater manifests report version `0.9.37`; every referenced installer size and SHA-512 relationship matches the downloaded artifact.
...
- macOS workflow: `https://github.com/cdfpartridge-web/RiftLite-Desktop-mac/actions/runs/31126023610`; GitHub cancelled it before assigning a runner or executing any step while the official Actions component reported a major outage. No `mac-v0.9.34` release or stale local Mac artifact was published.
...
- After GitHub Actions recovers, dispatch `build-mac.yml` again at the existing `mac-v0.9.34` tag, independently verify the five Mac assets, and finalize this section with their hashes without moving either release tag.
...
- TronIsBad and Zelonius are available through the desktop Home creator spotlight and normal creator discovery surfaces.
...
- At that checkpoint, the dirty desktop tree used package/build identity v0.9.70. Production continuity identifiers remained unchanged, so the existing RiftLite profile, matches, decks, replays, settings, media paths, and `riftlite:` links stayed on their established roots.
...
- The user explicitly directed installer publication after the v0.9.71 change. The handover's real-game desktop acceptance checks remained unrecorded and were carried as a known release risk rather than represented as passed.

## 2026-09-02 public v0.9.71 desktop release

- Windows release `v0.9.71` is public and Latest at https://github.com/cdfpartridge-web/RiftLite-Desktop/releases/tag/v0.9.71. Its annotated tag peels to immutable release source commit `459c3343af52ec65df95395a3b96e4afe0143a10`. The full gate passed lint, the **5-file / 81-test** account gate, all **175 files / 1,667 tests**, production builds, NSIS packaging, release verification, and packaged smoke. Fresh public downloads verified: installer `262,465,311` bytes / SHA-256 `597078162CD4DC2576AEBEE850CB101C834B2DA3DE3866B902A307F32D7FEB8B`; blockmap `249,753` bytes / `C92D9C2CB658792B5F35E9C73F1577991782E04A3990855806160ED9FC7472F8`; `latest.yml` `344` bytes / `8C731A6CE476E27F6C9C2EC29C114CF359F5B0C734286CA0CA50CED5E7836CDD`. The Windows executable is unsigned under the existing release configuration.
- macOS release `mac-v0.9.71` is public and Latest at https://github.com/cdfpartridge-web/RiftLite-Desktop-mac/releases/tag/mac-v0.9.71. Its annotated tag also peels to `459c334`. Native preflight run `33649154334` and tagged release run `33650033524` passed the complete gate, x64/arm64 packaging, architecture-specific FFmpeg checks, artifact/app/DMG verification, and packaged smoke. Fresh public downloads verified exactly five assets: `latest-mac.yml` `830` bytes / SHA-256 `F925806C9938C3FA0D9157132CB66AD010915F60C19F69B204AF4565A9810835`; ARM64 DMG `177,592,953` / `EF0FCB4D6DDD3E0755D2FF5DCC1411809DEBB4EF828C795DF8855EC5E1E220B6`; ARM64 ZIP `175,857,027` / `3BC90186D9DE381377544D903854825394531F51F092D55D2E4EED94F374F8EA`; x64 DMG `192,704,238` / `23C805A8516B84F320328BC9312BA59FB17A07750A9F980FEEAB44B09528C26D`; x64 ZIP `191,113,734` / `ED2B5848256538FD328E80779745917A3A17230F385FAFEBE7AF9A071264B1F4`. Every manifest size/SHA-512 relationship matched. macOS remains ad-hoc signed and not notarized.
- The handover's three real-game desktop acceptance checks remain unrecorded post-release and are carried as a known risk rather than represented as passed. v0.9.65 is now the superseded prior public release; neither v0.9.71 tag nor any verified release asset should be moved or replaced.

## 2026-09-04 public v0.9.72 Atlas compatibility hotfix

- Windows `v0.9.72` and macOS `mac-v0.9.72` are public and Latest from immutable source commit `19267728332ebb9c946d7a61d03715c149400589`. Both annotated tags peel to that commit, and both repositories' `release/v0.9.72` branches remain fixed there.
- The release adds the bounded Atlas Player-name-field layout repair, trusted focus/presentation recovery, privacy-safe interaction diagnostics, conservative passive cache-miss presentation, and the Matches scrolling-width/responsive fix. Search Rules remains hidden and Replay Coach remains Coming Soon.
- The authoritative LF-clean Windows release pipeline passed lint, the **5-file / 81-test** account gate, all **181 files / 1,783 tests**, production builds, NSIS packaging, release verification, and packaged smoke. Public assets: installer `159,339,221` bytes / SHA-256 `7E27AA6E2EAC45F25A9F94C8D2223B2B191AB173B3A6775602E537747D0ED5D4`; blockmap `143,014` / `3EA911A0909293CD2DE2C4EDC8AA921B096CF606CC8B400DB03A5027280FB9FF`; `latest.yml` `344` / `BE2EA215D3E69CE2FF3D14B77D8059541DC9EE10908F563FA2CDC1858A7DC5C3`.
- Native macOS preflight `33884837202` and tagged workflow `33885389449` both passed the full workflow. Public assets: `latest-mac.yml` `830` bytes / `F29DF26293E5FEAD0C3774F42718A612F19085BF4FA26794A375708C05A15CF5`; arm64 DMG `177,647,341` / `00FE54F433AF0A8F8A4AE89B4895999C4564CB90C6C94607DDAFA8958AFF084D`; arm64 ZIP `175,867,166` / `9773989177CF6D4F2C1A8FAB3249F5E94329A8E9F30A19C753B94AE26A59308B`; x64 DMG `192,780,102` / `6DAD110EC2C14F9DAF398F3EA362B73516CEB4C1289D3A13F47F55C6F15F4272`; x64 ZIP `191,123,870` / `55143760D3D57326D87DEDCE880D34C3E22270C151FF62B2E329F9ACBC4BD2CB`.
- Fresh public downloads verified exactly three Windows and five macOS assets, both updater versions, every declared size, and every manifest SHA-512 relationship. The Windows executable remains unsigned; macOS remains ad-hoc signed and not notarized.
- Exact-hash installed/live Atlas acceptance remains outstanding and must not be inferred from packaged smoke. Test signed-out typing, signed-in Player/Find Match/Host Room, Home-to-Play and alt-tab focus, replay video off/on, one short completed match, privacy-safe interaction diagnostic phases, normal lifecycle, and saved replay video quality.
